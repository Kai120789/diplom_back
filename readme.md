...
- Тесты интегрированные в курсы, чередующиеся с теорией.
...
- Архитектура проекта - fsd (feature sliced design).
- Разработка своего ui kit.
- Изначально не подразумевается использование стейт менеджера.
- В качестве препроцессора используется sass (scss).
- Адаптивный дизайн (резиновая верстка для 3-ех устройств - компьютер, телефон, планшет).
- Верстка разрабатывается, начиная с компьютера.
- SSR фреймворк - Next.js.
- Фреймворк для диаграмм - chart.js.

---

### 5. Этапы разработки

1. **Разработка тз проекта**.
2. **Анализ и проектирование**:

- Разработка ui дизайна проекта.
